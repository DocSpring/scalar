import { getTag } from '@scalar/api-reference/features/traverse-schema/helpers/get-tag'
import type { TagsMap, TraversedSchema } from '@scalar/api-reference/features/traverse-schema/types'
