...
import SidebarToggle from '@scalar/api-client/components/Sidebar/SidebarToggle.vue'
import { useLayout } from '@scalar/api-client/hooks'
import { useClientConfig } from '@scalar/api-client/hooks/useClientConfig'
import { useSidebar } from '@scalar/api-client/hooks/useSidebar'
import { ERRORS } from '@scalar/api-client/libs'
import { createRequestOperation } from '@scalar/api-client/libs/send-request'
import type { SendRequestResult } from '@scalar/api-client/libs/send-request/create-request-operation'
import { validateParameters } from '@scalar/api-client/libs/validate-parameters'
...
import { useOpenApiWatcher } from '@scalar/api-client/views/Request/hooks/useOpenApiWatcher'
