...
import Sidebar from '@scalar/api-client/components/Sidebar/Sidebar.vue'
import SidebarButton from '@scalar/api-client/components/Sidebar/SidebarButton.vue'
import SidebarList from '@scalar/api-client/components/Sidebar/SidebarList.vue'
import SidebarListElement from '@scalar/api-client/components/Sidebar/SidebarListElement.vue'
...
import type { EnvConfig } from '@scalar/api-client/libs/env-helpers'
