import { CLIENT_CONFIGURATION_SYMBOL } from '@scalar/api-client/hooks/useClientConfig'
import { type ClientLayout, LAYOUT_SYMBOL } from '@scalar/api-client/hooks/useLayout'
import { SIDEBAR_SYMBOL, createSidebarState } from '@scalar/api-client/hooks/useSidebar'
import { getRequestUidByPathMethod } from '@scalar/api-client/libs/get-request-uid-by-path-method'
import { loadAllResources } from '@scalar/api-client/libs/local-storage'
import { PLUGIN_MANAGER_SYMBOL, createPluginManager } from '@scalar/api-client/plugins'
import { ACTIVE_ENTITIES_SYMBOL, createActiveEntitiesStore } from '@scalar/api-client/store/active-entities'
import { WORKSPACE_SYMBOL, type WorkspaceStore, createWorkspaceStore } from '@scalar/api-client/store/store'
